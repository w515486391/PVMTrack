...
class CenterPredictor(nn.Module, ):
    def __init__(self, inplanes=64, channel=256, feat_sz=20, stride=16, freeze_bn=False):
        ...
        self.conv1_2_ctr = conv(channel, channel, freeze_bn=freeze_bn)
        ...
        self.conv1_2_offset = conv(channel, channel, freeze_bn=freeze_bn)
        self.conv1_3_offset = conv(channel, channel, freeze_bn=freeze_bn)
        self.conv1_4_offset = conv(channel, channel, freeze_bn=freeze_bn)
        ...
        self.conv1_2_size = conv(256, 256, freeze_bn=freeze_bn)
        self.conv1_3_size = conv(256, 256, freeze_bn=freeze_bn)
        self.conv1_4_size = conv(256, 256, freeze_bn=freeze_bn)
    ...
    def get_score_map(self, x):
        ...
        x_ctr1_2 = self.conv1_2_ctr(x_ctr1)

        x_ctr2 = self.conv2_ctr(x_ctr1_2)
        ...
        x_offset1_2 = self.conv1_2_offset(x_offset1)
        x_offset1_3 = self.conv1_3_offset(x_offset1_2)
        # x_offset1_4 = self.conv1_4_offset(x_offset1_3)

        x_offset2 = self.conv2_offset(x_offset1_3)
        ...
        x_size1_2 = self.conv1_2_size(x_size1)
        x_size1_3 = self.conv1_3_size(x_size1_2)
        # x_size1_4 = self.conv1_4_size(x_size1_3)

        x_size2 = self.conv2_size(x_size1_3)
